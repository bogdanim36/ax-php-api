...
final class DBMySQLi {
    ...
    public function begin_transaction(){
        try {
            ...
            throw new Exception("Cannot start MySQL transaction.\n". $e->getMessage() . "\n");
        }
    }
    public function commit(){
        try {
            ...
            throw new Exception("Cannot commit MySQL transaction.\n". $e->getMessage() . "\n");
        }
    }
    public function rollback(){
        try {
            ...
            throw new Exception("Cannot rollback MySQL transaction.\n". $e->getMessage() . "\n");
        }
    }
}